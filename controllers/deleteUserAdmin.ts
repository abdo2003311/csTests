...
let deleteUserAdmin = async (
    ...
    try {
        ...
        let user : userType = await User.findById(id).populate('solvedTests') as userType;   
        ...
        user = await User.findById(id).populate('solvedTests') as userType;   
