...
let PublishOrUpdateTest = (props) => {
    ...
    let handleSubmit = (e) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (testTitle.length && testDesc.length) {
            if (upadte === true) {
                yield axios_1.default.put(`http://localhost:8080/api/tests/${id}/${userName}`, {
                    title: testTitle,
                    desc: testDesc,
                    questions: data
                }, headers);
                ...
                yield axios_1.default.post(`http://localhost:8080/api/tests/${userName}`, {
                    title: testTitle,
                    desc: testDesc,
                    questions: data
                }, headers);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "publishOrUpdateTest" }, { children: [(0, jsx_runtime_1.jsxs)("h2", { children: [(upadte === true) ? 'edit test' : 'new test', " ", (test) ? test.title : '', " "] }), (0, jsx_runtime_1.jsxs)("form", Object.assign({ onSubmit: handleSubmit }, { children: [(0, jsx_runtime_1.jsx)("label", { children: "title" }), (0, jsx_runtime_1.jsx)("input", { type: 'text', id: 'testTitle', defaultValue: (test) ? test.title : '', required: true }), (0, jsx_runtime_1.jsx)("label", { children: "description" }), (0, jsx_runtime_1.jsx)("input", { type: 'text', id: 'testDesc', defaultValue: (test) ? test.desc : '', required: true }), (0, jsx_runtime_1.jsx)("button", Object.assign({ onClick: handleNewQuestion }, { children: "new Question" })), (0, jsx_runtime_1.jsx)("div", { children: data.map(question => (0, jsx_runtime_1.jsx)(QuestionForm_1.default, { question: question, order: questions.data.indexOf(question), allQuestions: data, setQuestions: setQuestions }, Math.random() * 100000)) }), (0, jsx_runtime_1.jsx)("button", { children: "submit" })] }))] })));
};
exports.default = PublishOrUpdateTest;
