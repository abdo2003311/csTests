...
let ArticlesForm = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "articlesForm" }, { children: [(0, jsx_runtime_1.jsx)("h2", { children: (edit === true) ? 'edit article' : 'new article' }), (0, jsx_runtime_1.jsxs)("form", Object.assign({ onSubmit: handleSubmit }, { children: [(0, jsx_runtime_1.jsx)("input", { type: 'text', id: 'articleTitle', placeholder: 'title', defaultValue: article.title, required: true }), (0, jsx_runtime_1.jsx)("textarea", { id: 'articleDesc', placeholder: 'desc', defaultValue: article.desc, required: true }), (0, jsx_runtime_1.jsx)("input", { type: 'text', id: 'articleCatagory', placeholder: 'catagory', defaultValue: article.catagory, required: true }), (0, jsx_runtime_1.jsx)("input", { type: 'file', id: "img", onChange: handleFile }), (0, jsx_runtime_1.jsx)("button", { children: "submit" })] }))] })));
};
exports.default = ArticlesForm;
